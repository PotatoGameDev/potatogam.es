---
layout: base-subpage.njk
title: Privacy Policy
description: Privacy policy for Spud Runner by PotatoGameDev.
---
# Privacy Policy

---

This privacy policy applies to the Flappy Planet app (hereby referred to as "Application") for mobile devices that was
created by Pixelheart Software Piotr Kaczmarski (hereby referred to as "Service Provider") as an Ad Supported service.
...
Provider (inbox@potatogam.es) so that they will be able to take the necessary actions. You must also be at least 16
...
contact the Service Provider via email at inbox@potatogam.es.
